...
API_ID = int(getenv("API_ID", 27275177))
API_HASH = getenv("API_HASH", "9c32a5f95ded142fbd3bcf026f27ed44")
BOT_TOKEN = getenv("BOT_TOKEN")

OWNER_ID = int(getenv("OWNER_ID", 5355178160))
OWNER_USERNAME = getenv("OWNER_USERNAME", "ttccss")
BOT_USERNAME = getenv("BOT_USERNAME", "Npx_bot")
BOT_NAME = getenv("BOT_NAME", "Queen")
ASSUSERNAME = getenv("ASSUSERNAME", "musicxannie")
EVALOP = list(map(int, getenv("EVALOP", "6797202080").split()))

# ───── Mongo & Logging ───── #
MONGO_DB_URI = getenv("MONGO_DB_URI", "mongodb+srv://abdelmajeedsayedasil_db_user:as345678@cluster0.w3ygbqj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
LOGGER_ID = int(getenv("LOGGER_ID", -1003017483099))
...
COOKIE_URL = getenv("COOKIE_URL", "https://batbin.me/passionless") #necessary
...
# ───── Support & Community ───── #
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Source_Queen")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/t.me/N_P_X00")
